...
local function set_buffer_key(bufnr, ...) vim.api.nvim_buf_set_keymap(bufnr, ...) end
...
function M.set_lsp_keymappings(bufnr)
  ...
  -- See `:help vim.lsp.*` for documentation on any of the below functions
	...
	local function set_current_buffer_normal_mode(...)  set_buffer_key(bufnr,'n', ...) end
  ...
  set_current_buffer_normal_mode( '<space>wl', '<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>', noremap_silent)
  ...
  set_current_buffer_normal_mode( '<space>e', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', noremap_silent)
